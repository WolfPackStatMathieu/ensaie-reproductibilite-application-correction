...
```{ojs}
prediction = `https://toto.kub.sspcloud.fr/predict?pclass=${class_boat}&sex=${gender}&age=${age}&sib_sp=1&parch=1&fare=16.5&embarked=S&title=${title}&has_cabin=1&ticket_len=7`
```
...
Retrouver l'API sur [https://toto.kub.sspcloud.fr/docs](https://toto.kub.sspcloud.fr/docs) pour jouer avec
d'autres exemples. 
